	...
	[1]={
		[1]={
			[1]={
				...
				text="DNT Ember Explosion Radius@{0}m"
			}
		},
		stats={
	...
	[2]={
		[1]={
			[1]={
				...
				text="DNT Ember Explosion Radius is {0} metre"
			},
			[2]={
				[1]={
					k="divide_by_ten_1dp_if_required",
				...
				text="DNT Ember Explosion Radius is {0} metres"
			}
		},
		stats={
	...
	[3]={
		[1]={
			[1]={
				...
				text="DNT Creates {0} flaming embers"
			}
		},
		stats={
