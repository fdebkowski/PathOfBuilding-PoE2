...
c["40% increased Elemental Ailment Threshold 130% increased Evasion Rating"]={{[1]={flags=0,keywordFlags=0,name="AilmentThreshold",type="INC",value=40}}," Elemental  130% increased Evasion Rating "}
